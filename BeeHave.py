...
class BeeHave(base.Component):
    ...
    # CHANGELOG
    VERSION.added("1.14.0", "`components.BeeHave` ")
    ...
    def run(self) -> None:
        ...
        shutil.copy(
            os.path.abspath(
                os.path.join(__file__, "..", "BEEHAVE-Model_2014-03-04", "1_BEEHAVE-MODEL_Beehave2013.nlogo")),
            processing_path
        )
        base.replace_tokens(
        ...
        base.run_process(
            (
                ...
                "--model",
                "1_BEEHAVE-MODEL_Beehave2013.nlogo",
                "--setup-file",
                "experiment.xml",
                "--table",
                output_file
    ...
    def create_forage_input_file(self, processing_path: str) -> None:
        ...
        output_file = os.path.join(processing_path, "Input_2-1_FoodFlow.txt")
        i = 1
